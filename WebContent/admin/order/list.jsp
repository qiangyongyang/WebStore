								...
								<c:forEach items="${allOrders}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="/WebStore/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}">发货</a>
												</c:if>
...
$(function(){
	...
	$(".myClass").click(function(){
		...
		if(txt=="订单详情"){
			...
			var url="/WebStore/AdminOrderServlet";
			...
			$.post(url,obj,function(data){
				...
				$.each(data,function(i,obj){
					var td="<tr><td><img src='/WebStore/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
					tb.append(td);				
				})
			},"json");
